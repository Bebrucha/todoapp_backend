...
public class TaskControllerIT {
    ...
    public void testUpdateTask() throws Exception {
        ...
        TaskDAO existingTask = new TaskDAO(1L, "Learning", "IsAHardProcess", LocalDate.of(2024, 12, 12), 1L, 1L, 1L);

        Mockito.when(taskRepository.findById(1L)).thenReturn(Optional.of(existingTask));

        TaskDAO updatedTask = new TaskDAO(1L, "Updated Learning", "Updated IsAHardProcess", LocalDate.of(2025, 1, 1),
                2L, 2L, 2L);
